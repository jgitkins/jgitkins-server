...
//    private final LoadBranchCommitHistoriesUseCase loadBranchCommitHistoriesUseCase;
    ...
    public ResponseEntity<CommitHistory> getCommitDetail(@PathVariable String taskCd,
    ...
    public ResponseEntity<List<CommitHistory>> getBranchCommitHistories(@PathVariable String taskCd,
                                                                        @PathVariable String repoName,
